...
wordcloud((termProbs[termProbs$Topic == 'Topic 1','Term'][1:10]), (termProbs[termProbs$Topic == 'Topic 1','Probability'][1:10]), colors=brewer.pal(9, "Blues"))
```

#### Topic 2
This topic touches on gender, especially transgender identities, and health:
```{r}
wordcloud((termProbs[termProbs$Topic == 'Topic 2','Term'][1:10]), (termProbs[termProbs$Topic == 'Topic 2','Probability'][1:10]), rot.per=.15, colors=brewer.pal(9, "Blues"))
```

#### Topic 3
This topic covers sex and relationships/households:
```{r}
wordcloud((termProbs[termProbs$Topic == 'Topic 3','Term'][1:10]), (termProbs[termProbs$Topic == 'Topic 3','Probability'][1:10]), rot.per=.15, colors=brewer.pal(9, "Blues"))
```

#### Topic 4
This seems to be around sexual orientation:
```{r}
wordcloud((termProbs[termProbs$Topic == 'Topic 4','Term'][1:10]), (termProbs[termProbs$Topic == 'Topic 4','Probability'][1:10]), rot.per=.15, colors=brewer.pal(9, "Blues"))
```

#### Topic 5
This doesn't seem to be a coherent topic at the moment:
```{r}
wordcloud((termProbs[termProbs$Topic == 'Topic 5','Term'][1:10]), (termProbs[termProbs$Topic == 'Topic 5','Probability'][1:10]), rot.per=.15, colors=brewer.pal(9, "Blues"))
```

To summarize, our topics are:
```{r}
topicNames <- data.frame(Topic= colnames(termsByTopic), Description = c("Surveys", "Gender and Trans Identities", "Relationships/Households", "Sexual Orientation","Unknown"))
topicNames
```
...
If we just look at the primary topics and compare them by frequency, i.e. how many documents have that primary topic assignment. 
